...
class Relatorio(Contas, Dados, Estrutura):
    ...
    def criar_ted(
        ...
        cnv = canvas.Canvas(f'{self.pasta}/guias/{origem}/{data_pagamento}/TEDS/{pagamento[0]}-{conta[1]}-{conta[2]}.pdf')
        cnv.setPageSize(A4)
    ...
    def cria_transferencia(self, pagamento, empresa, conta, origem, data_pagamento):
        ...
        for i in range(0, 2):
            ...
            cnv.line(self.mm(102), self.mm(268 - contador), self.mm(102), self.mm(215 - contador))  # Linha central
            cnv.line(self.mm(196), self.mm(268 - contador), self.mm(196), self.mm(206 - contador))  # linha direita
            cnv.line(self.mm(8), self.mm(268 - contador), self.mm(8), self.mm(206 - contador))  # linha esquerda
            #cnv.line(self.mm(25), self.mm(268 - contador), self.mm(25), self.mm(258 - contador))  # divisão linha 1.1
            ...
            cnv.line(self.mm(8), self.mm(230 - contador), self.mm(196), self.mm(230 - contador))  # linha horizontal 4
            cnv.line(self.mm(8), self.mm(225 - contador), self.mm(196), self.mm(225 - contador))  # linha horizontal 9
            cnv.line(self.mm(8), self.mm(220 - contador), self.mm(196), self.mm(220 - contador))  # linha horizontal 5
            cnv.line(self.mm(8), self.mm(215 - contador), self.mm(196), self.mm(215 - contador))  # linha horizontal 6
            cnv.line(self.mm(8), self.mm(210 - contador), self.mm(196), self.mm(210 - contador))  # linha horizontal 7
            #cnv.line(self.mm(8), self.mm(193 - contador), self.mm(196), self.mm(193 - contador))  # linha horizontal 8

            cnv.line(self.mm(8), self.mm(205 - contador), self.mm(8),
                     self.mm(200 - contador))  # linha vertical id esquerda
            cnv.line(self.mm(75), self.mm(205 - contador), self.mm(75),
                     self.mm(200 - contador))  # linha vertica id direita
            cnv.line(self.mm(8), self.mm(200 - contador), self.mm(75), self.mm(200 - contador))  # linha horizontal id
            cnv.line(self.mm(8), self.mm(185 - contador), self.mm(196),
                     self.mm(185 - contador))  # linha horizontal assinatura
            cnv.line(self.mm(102), self.mm(194 - contador), self.mm(102),
                     self.mm(185 - contador))  # linha vertical assinatura
            ...
            cnv.rect(self.mm(25), self.mm(216 - contador), width=self.mm(3), height=self.mm(3))
            cnv.rect(self.mm(105), self.mm(216 - contador), width=self.mm(3), height=self.mm(3))


            cnv.rect(self.mm(12), self.mm(50), width=self.mm(180), height=self.mm(5))

            altura = 0
            for i in range(0, 9):
                cnv.rect(self.mm(12), self.mm(45 - altura), width=self.mm(180), height=self.mm(5))
                altura += 5
            ...
            cnv.drawString(self.mm(10), self.mm(237 - contador), "Telefone(s)")
            #cnv.drawString(self.mm(104), self.mm(215 - contador), "Nº Identidade / Órgão expedidor / UF")
            ...
            cnv.drawString(self.mm(10), self.mm(217 - contador), "Finalidade")
            cnv.drawString(self.mm(10), self.mm(212 - contador), "Histórico")
            cnv.drawString(self.mm(10), self.mm(207 - contador), "Nº Identificação Depósito")
            # cnv.drawString(self.mm(155), self.mm(195 - contador),
            #                f"{pagamento[0][0:3]}-{self.formatar_nome(pagamento[1])} {pagamento[2]}")
            cnv.drawString(self.mm(155), self.mm(204 - contador), f"Impresso em {self.data_formatada}")
            cnv.drawString(self.mm(76), self.mm(202 - contador),
                           "Preencher somente nas transferências de recursos para deposito judicial")
            cnv.drawString(self.mm(10), self.mm(197 - contador),
                           "Autorizo o Banco a DEBITAR em minha Conta de Depósitos, nesta Agência, o valor da presente transferência de fundos.")
            cnv.drawString(self.mm(17), self.mm(182 - contador),
                           "Diego Fernandes da Silva - Diretor Administrativo - Matrícula: 1.693.844-5")
            cnv.drawString(self.mm(114), self.mm(182 - contador),
            ...
            cnv.drawString(self.mm(30), self.mm(216 - contador), "00001 - Pagamento de ipostos, tributos e taxas")
            cnv.drawString(self.mm(110), self.mm(216 - contador), "00005 - Pagamentos de fornecedores")
            ...
            cnv.drawString(self.mm(106), self.mm(217 - contador), "\u2713")
            ...
            cnv.drawString(self.mm(84), self.mm(177 - contador), 'Assinatura do Remetente')
            ...
            cnv.drawString(self.mm(10), self.mm(232 - contador), "(61) 2017-1821")  # telefone
            ...
            cnv.drawString(self.mm(30), self.mm(52), "SEI")
            cnv.drawString(self.mm(60), self.mm(52), "Cotação")
            cnv.drawString(self.mm(90), self.mm(52), "Valor total")
            cnv.drawString(self.mm(120), self.mm(52), "Impostos retidos")
            cnv.drawString(self.mm(150), self.mm(52), "Valor líquido")
        ...
        cnv.setDash([3, 1])
        cnv.line(self.mm(8), self.mm(174), self.mm(196), self.mm(174))
        cnv.save()
