...
class Relatorio(Contas, Dados, Estrutura):
    ...
    def cria_transferencia(self, pagamento, empresa, conta, origem, data_pagamento):
        ...
        for i in range(0, 2):
            ...
            #cnv.line(self.mm(8), self.mm(215 - contador), self.mm(196), self.mm(215 - contador))  # linha horizontal 7
            #cnv.line(self.mm(8), self.mm(210 - contador), self.mm(196), self.mm(210 - contador))  # linha horizontal 8
            #cnv.line(self.mm(8), self.mm(193 - contador), self.mm(196), self.mm(193 - contador))  # linha horizontal 9
