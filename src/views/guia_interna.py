    ...
    def gerar_guia(self, contador: int, imposto=False):
        for i in range(0, 2):
            ...
            if not imposto:
                ...
                self.inserir_strings('Times-Bold', 8, TIMESB8FORNECEDOR, self.contador, self.dados['Conta_destino'])
        ...
        self.gerar_area_de_pagamentos(LINHAS_PAGAMENTOS, RETANGULO_PAGAMENTO, TIMES8_PAGAMENTOS, 5)
